...
const fallbackBoard = [
  { name_ar: "خالد سالم العواشز", name_en: "Khaled Salem Al-Awashez", role_ar: "رئيس مجلس الإدارة", role_en: "Chairman", color_class: "from-[#1C6C81] to-[#2A8DA8]" },
  { name_ar: "عبدالله عبدالمحسن الدوسري", name_en: "Abdullah Al-Dosari", role_ar: "نائب رئيس مجلس الإدارة", role_en: "Vice Chairman", color_class: "from-[#D4A533] to-[#E8C84B]" },
  { name_ar: "أحمد إبراهيم الزيداني", name_en: "Ahmed Al-Zaidani", role_ar: "عضو", role_en: "Member", color_class: "from-[#1C6C81] to-[#2A8DA8]" },
  { name_ar: "عمر محمد أبو ملحة", name_en: "Omar Abu Malha", role_ar: "عضو", role_en: "Member", color_class: "from-[#D4A533] to-[#E8C84B]" },
  { name_ar: "سعد إبراهيم آل مهدي", name_en: "Saad Al Mahdi", role_ar: "عضو", role_en: "Member", color_class: "from-[#1C6C81] to-[#2A8DA8]" },
];
